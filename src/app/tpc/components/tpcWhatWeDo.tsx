...
import EventModal from "./tpcEventMore";
...
const WhatWeDo = () => {
  ...
  const openImmersion = () => {
    setSelectedProgram({
      title: t("TPCwhatWeDo.tpcEvent1.title"),
      description: t("TPCwhatWeDo.tpcEvent1.detail"),
  ...
  const openCeoBootcamp = () => {
    setSelectedProgram({
      title: t("TPCwhatWeDo.tpcEvent2.title"),
      description: t("TPCwhatWeDo.tpcEvent2.detail"),
  ...
  const openEventTourist = () => {
    setSelectedProgram({
      title: t("TPCwhatWeDo.tpcEvent3.title"),
      description: t("TPCwhatWeDo.tpcEvent3.detail"),
